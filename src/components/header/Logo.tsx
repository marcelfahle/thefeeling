...
type Props = { siteTitle?: string; className?: string }

export default function Logo({ siteTitle = 'THE FEELING', className = 'front' }: Props) {
  return (
    <svg
      viewBox="0 0 300 46"
      version="1.1"
      ...
      <g>
        ...
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Logo_THEFEELING">
            <rect id="ROT" style={{ fill: 'var(--pal-left-bg)' }} x="0" y="0" width="150" height="46" />
            ...
            <rect id="ORANGE" style={{ fill: 'var(--pal-right-bg)' }} x="150" y="0" width="150" height="46" />
